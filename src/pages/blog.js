            ...
            <div className="category-filter dropdown">
              ...
              {this.state.openDropdown && (
                <div className="category-filter-option">
                  <span>All</span>
                  {this.state.categoryFilter.category === "all" && (
                    <i
                  ...
                  {this.state.categoryFilter.category !== "all" && (
                    <i
                      ...
                      onClick={() => {
                        this.changeCategory({ category: "all" });
                      }}
                    ></i>
                  )}
                </div>
              ...
              {this.state.openDropdown &&
                this.state.categories.map((category, i) => {
                  return (
                    <div key={i} className="category-filter-option">
                      <span>{category}</span>
                      {this.state.categoryFilter.category === category && (
                        <i
                          style={{ paddingLeft: "10px" }}
                          className="fa fa-square"
                        ></i>
